...
plot_training_results<-function(training_results,training_type){
  ...
  p1<-ggplot(training_results,aes(Tmin,pred_Tmin))+geom_point(size=0.8)+ labs(subtitle = "(a)")+theme_bw()+
    geom_abline(slope=1, intercept=0)+labs(y= expression(paste("Reconstructed T"[min] ( degree~C))), x = expression(paste("T"[min] ( degree~C))))
  
  p2<-ggplot(training_results,aes(gdd,pred_gdd))+geom_point(size=0.8)+labs(subtitle = "(b)")+theme_bw()+
    geom_abline(slope=1, intercept=0)+labs(y= bquote('Reconstructed'~ GDD[0]), x = bquote(GDD[0]))
  
  p3<-ggplot(training_results,aes(alpha,pred_alpha))+geom_point(size=0.8)+ labs(subtitle = "(c)")+theme_bw()+
    geom_abline(slope=1, intercept=0)+labs(y= expression("Reconstructed "*alpha), x = expression(alpha))
  
  p4<-ggplot(training_results,aes(Tmin,difference_Tmin))+geom_point(size=0.8)+ labs(subtitle = "(d)")+theme_bw()+
    geom_abline(slope=0, intercept=0)+labs(y= expression(paste("Residual of T"[min] ( degree~C))), x = expression(paste("T"[min] ( degree~C))))
  
  p5<-ggplot(training_results,aes(gdd,difference_gdd))+geom_point(size=0.8)+ labs(subtitle = "(e)")+theme_bw()+
    geom_abline(slope=0, intercept=0)+labs(y= bquote('Residual of'~ GDD[0]), x = bquote(GDD[0]))
  
  p6<-ggplot(training_results,aes(alpha,difference_alpha))+geom_point(size=0.8)+ labs(subtitle = "(f)")+theme_bw()+
    geom_abline(slope=0, intercept=0)+labs(y= expression("Residual of "*alpha), x = expression(alpha))
  
  
  p<-arrangeGrob(p1,p4,p2,p5,p3,p6 ,ncol = 2)
...
Plot_fossil<-function(plotdata,modern_gdd,modern_alpha,modern_Tmin,insol_summer_winter){
  ...
  p1<-ggplot(plotdata, aes(x = Age.cal.BP, y = Tmin, colour = Site))+geom_point(size=0.8)+geom_line()+
    ...
    scale_x_continuous(breaks = xbreak,limits = c(-1200,12000))+theme_bw()+
  ...
  p3<-ggplot(plotdata, aes(x = Age.cal.BP, y = alpha, colour = Site))+geom_point(size=0.8)+geom_line()+
    ...
    scale_x_continuous(breaks = xbreak,limits = c(-1200,12000))+ylim(0,1.05)+theme_bw()+
  ...
  p4<-ggplot(insol_summer_winter)+geom_line(aes(Age,Insolation_winter,colour=Site))+
    labs(subtitle = "(d)")+ scale_color_brewer(palette="Dark2")+theme_bw()+
  ...
  p5<-ggplot(insol_summer_winter)+geom_line(aes(Age,Insolation_summer,colour=Site))+
    labs(subtitle = "(e)")+ scale_color_brewer(palette="Dark2")+theme_bw()+
    scale_x_continuous(breaks = xbreak,limits = c(0,12000))+
  ...
  ggsave(file="Climate reconstruction at the fossil sites.png",p,width=9,height=9)
}
...
Plot_fossil_each_site_with_SE<-function(plotdata,insol_site,sitename,bci){
  ...
  xbreak<-c(0,2000,4000,6000,8000,10000,12000)
  p1<-ggplot(plotdata, aes(x = Age.cal.BP, y = Tmin))+theme_bw()+
  ...
  p2<-ggplot(plotdata, aes(x = Age.cal.BP, y = gdd))+theme_bw()+
  ...
  p3<-ggplot(plotdata, aes(x = Age.cal.BP, y = alpha))+theme_bw()+
  ...
  p4<-ggplot(insol_site)+geom_line(aes(Age,Insolation_summer))+theme_bw()+
  ...
  ggsave(file=paste("Climate reconstruction at",sitename,".png"),p,width=6,height=4)
}
...
plot_relationship<-function(plotdata,traindata){
  ...
  p1<-ggplot(traindata, aes(x = alpha, y = gdd))+geom_point(size=0.8)+labs(subtitle = "(a)")+theme_bw()+
    xlab(expression(alpha))+ylab(bquote(GDD[0]))
  
  p2<-ggplot(plotdata, aes(x = alpha, y = gdd,colour=Site))+geom_point(size=0.8)+labs(subtitle = "(b)")+theme_bw()+
...
plot_spatial_gradient_colour<-function(plotGradient,method){
  ...
  p1<-ggplot(plotGradient)+labs(subtitle = expression(paste("(a) T"[min] ( degree~C))))+theme_bw()+
  ...
  p2<-ggplot(plotGradient)+labs(subtitle = bquote('(b)'~ GDD[0]))+theme_bw()+
  ...
  p3<-ggplot(plotGradient)+labs(subtitle = expression("(c) "*alpha))+theme_bw()+
...
library(grid)
library(gridExtra)
p_Tmin<-ggplot(P,aes(u3,t3))+geom_point(size=0.8)+labs(subtitle = "(e)")+ theme_bw()+
  labs(y= expression(paste("Tolerance of T"[min] ( degree~C))), x =expression(paste("Optimum of T"[min] ( degree~C))))
p_gdd<-ggplot(P,aes(u1,t1))+geom_point(size=0.8)+labs(subtitle = "(f)")+theme_bw()+
  labs(y= bquote('Tolerance of'~ GDD[0]), x = bquote('Optimum of'~ GDD[0]))
p_alpha<-ggplot(P,aes(u2,t2))+geom_point(size=0.8)+labs(subtitle = "(g)")+theme_bw()+
...
########################################################################################################
############    Maps to show the training data (Figure 2) and fossil data (Figure 3, Table 1)    ###############
########################################################################################################
# Maps -------------------------------------------------------------------
#Modern sites
library(maps)
...
#Each site with standard error (Figure S2 ~ S8)
